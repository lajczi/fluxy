...
const command: Command = {
  ...
  async execute(message, args, client, prefix = '!') {
    ...
    if (!sub || sub === 'help') {
      ...
      const embed = new EmbedBuilder()
        ...
        .addFields(
          ...
          {
            name: t('en', 'commands.admin.starboard.help.fieldAliases'),
            value: t('en', 'auditCatalog.commands.admin.starboard.l95_addFields_value'),
            inline: true,
          },
          {
            name: t('en', 'commands.admin.starboard.help.fieldCooldown'),
            value: t('en', 'auditCatalog.commands.admin.starboard.l96_addFields_value'),
            inline: true,
          },
    ...
    try {
      ...
      const needsAdmin = !['leaderboard', 'lb', 'top', 'topusers', 'stats'].includes(sub);
      ...
      switch (sub) {
        ...
        case 'channel': {
          ...
          const embed = new EmbedBuilder()
            ...
            .addFields(
              {
                name: t(lang, 'commands.admin.starboard.setup.fieldThreshold'),
                value: t(lang, 'commands.admin.starboard.setup.thresholdReactions', {
                  threshold: board?.threshold ?? 3,
                }),
                inline: true,
              },
        ...
        case 'threshold': {
          ...
          if (!board) {
            if (boards.length > 1)
              return void (await message.reply(t(lang, 'auditCatalog.commands.admin.starboard.l201_reply')));
            return void (await message.reply(t(lang, 'commands.admin.starboard.setup.usage', { prefix })));
          }
        ...
        case 'emoji': {
          ...
          if (!rawEmoji) {
            ...
            return void (await message.reply(
              t(lang, 'commands.admin.starboard.emoji.usage', { prefix, currentEmoji: current }),
            ));
          }
        ...
        case 'disable': {
          ...
          settingsCache.invalidate(guild.id);
          return void (await message.reply(
            t(lang, 'commands.admin.starboard.toggle.setDone', { status: board.enabled ? 'enabled' : 'disabled' }),
          ));
        }
        ...
        case 'selfstar': {
          ...
          settingsCache.invalidate(guild.id);
          return void (await message.reply(
            t(lang, 'commands.admin.starboard.selfstar.setDone', {
              status: board.selfStarEnabled ? 'enabled' : 'disabled',
            }),
          ));
        }
        ...
        case 'ignorechannel': {
          ...
          if (!targetChannelId)
            return void (await message.reply(t(lang, 'commands.admin.starboard.ignorechannel.usage', { prefix })));
          ...
          if (idx === -1) {
            ...
            settingsCache.invalidate(guild.id);
            return void (await message.reply(
              t(lang, 'commands.admin.starboard.ignorechannel.nowIgnored', { channelId: targetChannelId }),
            ));
          } else {
            ...
            settingsCache.invalidate(guild.id);
            return void (await message.reply(
              t(lang, 'commands.admin.starboard.ignorechannel.noLongerIgnored', { channelId: targetChannelId }),
            ));
          }
        }
        ...
        case 'ignorerole': {
          if (!args[1])
            return void (await message.reply(t(lang, 'commands.admin.starboard.ignorerole.usage', { prefix })));
        ...
        case 'lb': {
          ...
          const entries = await StarboardMessage.find(query).sort({ starCount: -1 }).limit(10).lean();
        ...
        case 'stats': {
          ...
          const embed = new EmbedBuilder()
            ...
            .addFields(
              {
                name: t(lang, 'commands.admin.starboard.stats.trackedMessages'),
                value: `${totalEntries}`,
                inline: true,
              },
              { name: t(lang, 'commands.admin.starboard.stats.totalStars'), value: `${totalStars}`, inline: true },
              {
                name: t(lang, 'commands.admin.starboard.stats.postedToStarboard'),
                value: `${postedCount}`,
                inline: true,
              },
            );
          ...
          if (boardBreakdown.length > 0) {
            ...
            embed.addFields({
              name: t(lang, 'auditCatalog.commands.admin.starboard.l479_addFields_name'),
              value: lines.join('\n'),
              inline: false,
            });
          }
        ...
        case 'force': {
          ...
          if (!targetChannelId)
            return void (await message.reply(t(lang, 'commands.admin.starboard.force.couldNotDetermineChannel')));
          ...
          if (!board || !board.channelId)
            return void (await message.reply(t(lang, 'commands.admin.starboard.force.noStarboardChannel', { prefix })));
          ...
          try {
            ...
            if (!msgData?.id)
              return void (await message.reply(t(lang, 'commands.admin.starboard.force.couldNotFetchMessage')));

            const content =
              msgData.content?.length > 1024
            ...
            const starEmbed = new EmbedBuilder()
              ...
              .setColor(starColor)
              .setFooter({
                text: t(lang, 'auditCatalog.commands.admin.starboard.l535_setFooter', { starEmoji, targetMessageId }),
              });
            ...
            return void (await message.reply(
              t(lang, 'commands.admin.starboard.force.failed', {
                error: err.message || t(lang, 'commands.admin.starboard.force.unknownError'),
              }),
            ));
          }
        }
        ...
        case 'delete': {
          ...
          if (!/^\d{17,19}$/.test(args[1]))
            return void (await message.reply(t(lang, 'commands.admin.starboard.remove.invalidMessageId')));
          ...
          if (!entries || entries.length === 0)
            return void (await message.reply(t(lang, 'commands.admin.starboard.remove.notInStarboard')));
