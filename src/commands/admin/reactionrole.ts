...
function usageEmbed(prefix: string, lang: string) {
  return {
    ...
    color: 0x5865F2,
    fields: [
      { name: t(lang, 'commands.admin.reactionrole.help.fieldPostName', { prefix }), value: t(lang, 'commands.admin.reactionrole.help.fieldPostValue'), inline: false },
      { name: t(lang, 'commands.admin.reactionrole.help.fieldAddName', { prefix }), value: t(lang, 'commands.admin.reactionrole.help.fieldAddValue'), inline: false },
      { name: t(lang, 'commands.admin.reactionrole.help.fieldAddMultiName', { prefix }), value: t(lang, 'commands.admin.reactionrole.help.fieldAddMultiValue'), inline: false },
      { name: t(lang, 'commands.admin.reactionrole.help.fieldRemoveName', { prefix }), value: t(lang, 'commands.admin.reactionrole.help.fieldRemoveValue'), inline: false },
      { name: t(lang, 'commands.admin.reactionrole.help.fieldEditName', { prefix }), value: t(lang, 'commands.admin.reactionrole.help.fieldEditValue'), inline: false },
      { name: t(lang, 'commands.admin.reactionrole.help.fieldClearName', { prefix }), value: t(lang, 'commands.admin.reactionrole.help.fieldClearValue'), inline: false },
      { name: t(lang, 'commands.admin.reactionrole.help.fieldListName', { prefix }), value: t(lang, 'commands.admin.reactionrole.help.fieldListValue'), inline: false },
      { name: t(lang, 'commands.admin.reactionrole.help.fieldDmName', { prefix }), value: t(lang, 'commands.admin.reactionrole.help.fieldDmValue'), inline: false },
      { name: t(lang, 'commands.admin.reactionrole.help.fieldSwitchName', { prefix }), value: t(lang, 'commands.admin.reactionrole.help.fieldSwitchValue'), inline: false },
    ],
...
const command: Command = {
  ...
  async execute(message, args, client, prefix = '!') {
    ...
    if (subcommand === 'post') {
      ...
      if (!channel) return void await message.reply(t(lang, 'commands.admin.reactionrole.common.channelNotFoundDetailed'));
    ...
    if (subcommand === 'add') {
      ...
      if (commandMember) {
        ...
        if (!check.allowed) return void await message.reply(check.reason || t(lang, 'commands.admin.reactionrole.add.cannotManageRoleFallback'));
      }
      ...
      try {
        ...
        return void await message.reply(t(lang, 'commands.admin.reactionrole.common.reactPermissionError', { emojiArg, channelId: channel.id }));
      }
      ...
      try {
        ...
        if (entry) {
          ...
          if (entry.roles.some((r: any) => r.emoji === emoji)) {
            return void await message.reply(t(lang, 'commands.admin.reactionrole.common.alreadyMapped', { emojiArg }));
          }
      ...
      return void await message.reply(t(lang, 'commands.admin.reactionrole.add.done', { emojiArg, roleId, hierarchyWarning }));
    }
    ...
    if (subcommand === 'edit') {
      ...
      if (!newText) {
        return void await message.reply(t(lang, 'commands.admin.reactionrole.edit.missingTextPrompt', { prefix, channelName: channel.name, messageId }));
      }
      ...
      try {
        ...
        return void await message.reply(t(lang, 'commands.admin.reactionrole.edit.updated', { channelId: channel.id }));
      } catch (err: any) {
        if (isNetworkError(err)) {
    ...
    if (subcommand === 'remove') {
      ...
      try {
        ...
        if (entry.roles.length === before) {
          return void await message.reply(t(lang, 'commands.admin.reactionrole.remove.mappingNotFound', { emojiArg }));
        }
    ...
    if (subcommand === 'clear') {
      ...
      try {
        ...
        if (!entry) return void await message.reply(t(lang, 'commands.admin.reactionrole.clear.noneFound', { prefix }));
    ...
    if (subcommand === 'list') {
      try {
        ...
        const fields = reactionRoles.map((rr: any, i: number) => ({
          name: t(lang, 'commands.admin.reactionrole.list.panelName', { index: i + 1, channelId: rr.channelId, messageId: rr.messageId }),
    ...
    if (subcommand === 'switch') {
      ...
      if (!removeRoleId) return void await message.reply(t(lang, 'commands.admin.reactionrole.switch.invalidRemoveRole'));
      ...
      if (!removeRole) return void await message.reply(t(lang, 'commands.admin.reactionrole.switch.removeRoleNotFound'));
      ...
      if (commandMember) {
        ...
        if (!check1.allowed) return void await message.reply(check1.reason || t(lang, 'commands.admin.reactionrole.switch.cannotManageAddRoleFallback'));
        const check2 = canManageRole(commandMember, removeRole, guild);
        if (!check2.allowed) return void await message.reply(check2.reason || t(lang, 'commands.admin.reactionrole.switch.cannotManageRemoveRoleFallback'));
      }
      ...
      try {
        ...
        if (entry) {
          ...
          if (entry.roles.some((r: any) => r.emoji === emoji)) {
            return void await message.reply(t(lang, 'commands.admin.reactionrole.switch.alreadyMappedRemoveFirst', { emojiArg, prefix }));
          }
      ...
      return void await message.reply(t(lang, 'commands.admin.reactionrole.switch.done', {
        emojiArg,
    ...
    if (subcommand === 'addmulti') {
      ...
      for (const roleArg of roleArgs) {
        ...
        if (!roleId) return void await message.reply(t(lang, 'commands.admin.reactionrole.addmulti.invalidRole', { roleArg }));
        if (resolvedRoleIds.includes(roleId)) return void await message.reply(t(lang, 'commands.admin.reactionrole.addmulti.duplicateRole', { roleId }));
      ...
      for (const roleId of resolvedRoleIds) {
        ...
        if (!role) return void await message.reply(t(lang, 'commands.admin.reactionrole.addmulti.roleNotFound', { roleId }));

        let commandMember = guild.members?.get(message.author.id);
        if (!commandMember) { try { commandMember = await guild.fetchMember(message.author.id); } catch {} }
        if (commandMember) {
          const check = canManageRole(commandMember, role, guild);
          if (!check.allowed) return void await message.reply(check.reason || t(lang, 'commands.admin.reactionrole.addmulti.cannotManageRoleFallback', { roleName: role.name }));
        }
      ...
      try {
        ...
        if (entry) {
          ...
          if (entry.roles.some((r: any) => r.emoji === emoji)) {
            return void await message.reply(t(lang, 'commands.admin.reactionrole.addmulti.alreadyMappedRemoveFirst', { emojiArg, prefix }));
          }
          entry.roles.push(roleEntry);
        } else {
          settings.reactionRoles.push({ messageId, channelId: channel.id, roles: [roleEntry] });
      ...
      return void await message.reply(t(lang, 'commands.admin.reactionrole.addmulti.done', { emojiArg, roleCount: resolvedRoleIds.length, roleList }));
    }
